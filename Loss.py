...
class SupConLoss(nn.Module):
    ...
    def __init__(self, temperature, contrast_mode='all', base_temperature=0.07):
    ...
    def forward(self, features, labels=None, mask=None):
        """Compute loss for model. Both `labels` and `mask` are None, it equals to SimCLR unsupervised loss:
