...
import torch
import train_heart
import train_position_heart
import torch.optim as optimize
from SemanticMask_Datasets import SMDataset_withClusters, SMDataset, SMDataset_Position
...
net = train_position_heart.Encoder()
optimizer = optimize.Adam(net.parameters(), lr = 0.001)
trainloader_SemanticMask_position = torch.utils.data.DataLoader(data_train_position, batch_size=151)  
net,training_loss = train_position_heart.train_dnn_position(net,0.01,1000,optimizer,trainloader_SemanticMask_position)
