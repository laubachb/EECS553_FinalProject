...
X_train = np.load('pima_data/X_train_saheart.npy')   
y_train = np.load('pima_data/y_train_saheart.npy')  
X_valid = np.load('pima_data/X_valid_saheart.npy')    
y_valid = np.load('pima_data/y_valid_saheart.npy')
X_test = np.load('pima_data/X_test_saheart.npy')   
y_test = np.load('pima_data/y_test_saheart.npy')
cluster_assignment = np.load('pima_data/saheart_clusters.npy')
cluster_assignment_description = np.load('pima_data/saheart_clusters_description.npy')
